...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
  ...
  <?php if(empty($user)):?>
  <a class="btn btn-outline-primary" href="/test/user/registration">Регистрация</a>
  <a class="btn ml-1 btn-outline-primary" href="/test/user/authorization">Авторизация</a>
  </div>
</header>
